...
const milestones = [
  {
    ...
    title: "Founded",
    description:
      "Simmerium Control Chemicals established in Houston, TX and Port Harcourt, Nigeria. with a focus on Production Chemicals.",
  },
  {
    year: "2009",
    title: "Middle East Expansion",
    description:
      "Opened first international office in Abu Dhabi, U.A.E., serving the growing Gulf energy market.",
  },
  {
    year: "2013",
  ...
  },
  {
    ...
    title: "100+ Products",
    description:
      "Portfolio expanded to over 100 Formulations across all major oilfield Chemistry categories.",
  },
  {
    year: "2024",
    title: "Global Safety Award",
    description:
      "Achieved 500,000 man-hours without a lost-time incident across all operations.",
  },
];
